  ...
  head: () => ({
    meta: [
      { title: "Contact — Haven M Construction | Verona, NJ" },
      {
        name: "description",
        content:
          "Contact Haven M Construction in Verona, NJ for veterinary hospital construction or luxury home remodeling estimates.",
      },
      { property: "og:title", content: "Contact Haven M Construction" },
      {
        property: "og:description",
        content: "Get a free estimate for veterinary or residential construction in New Jersey.",
      },
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          ...
          <Reveal delay={0.1} className="flex flex-col gap-5">
            <a
              ...
              className="group flex items-center gap-5 rounded-2xl border border-border bg-card p-6 transition hover:border-primary/30"
            >
            ...
            <a
              href="mailto:info@havenmconstruction.com"
              className="group flex items-center gap-5 rounded-2xl border border-border bg-card p-6 transition hover:border-primary/30"
            >
              <div className="grid h-12 w-12 place-items-center rounded-xl bg-[var(--navy)]/8 text-[var(--navy)] group-hover:bg-[var(--navy)] group-hover:text-[var(--gold)]">
