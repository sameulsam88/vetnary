  ...
  head: () => ({
    meta: [
      { title: "Haven M Construction — Veterinary Hospitals & Luxury Remodeling | NJ" },
      {
        name: "description",
        content:
          "Specialized veterinary hospital construction, commercial build-outs, and premium home remodeling throughout New Jersey. Licensed & insured.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Specialized veterinary facility construction and premium remodeling throughout New Jersey.",
      },
...
const SPECS = [
  {
    icon: Activity,
    title: "Patient Flow",
    body: "Separation of healthy intake, sick patients, and surgical recovery with thoughtfully zoned circulation.",
  },
  {
    icon: Layers,
    title: "Exam Room Layouts",
    body: "Modular exam rooms with integrated casework, sinks, and equipment for fast turnover between patients.",
  },
  {
    icon: HardHat,
    title: "Surgical Areas",
    body: "Sterile-zone construction, medical gas, scrub rooms, and recovery suites built to clinical standards.",
  },
  {
    icon: Wind,
    title: "HVAC Requirements",
    body: "Zoned ventilation, negative-pressure isolation, and odor control engineered for animal care environments.",
  },
  {
    icon: CheckCircle2,
    title: "Durable Materials",
    body: "Antimicrobial flooring, sealed wall systems, and finishes that withstand cleaning chemicals and high traffic.",
  },
  {
    icon: PawPrint,
    title: "Pet-Friendly Environments",
    body: "Acoustic treatment, calming finishes, and sight-line planning that reduce patient stress.",
  },
];
...
const PROJECTS = [
  {
    ...
    title: "Cedar Grove Animal Hospital",
    desc: "Ground-up 8,400 sq ft hospital with surgical suite and boarding.",
  },
  {
    img: projKitchen,
    tag: "Luxury Kitchen",
    title: "Montclair Chef's Kitchen",
    desc: "Custom white-oak cabinetry, marble waterfall island, brass detailing.",
  },
  {
    img: projConstr,
    tag: "Whole Home",
    title: "Verona Estate Renovation",
    desc: "Whole-home rebuild including additions and exterior restoration.",
  },
  {
    img: projBasement,
    tag: "Basement",
    title: "Livingston Lower Level",
    desc: "Theater, wet bar, guest suite, and full bath in 2,200 sq ft basement.",
  },
];
...
const PROCESS = [
  {
    n: "01",
    title: "Consultation",
    body: "We listen, walk your site, and align on scope, schedule, and budget.",
  },
  {
    n: "02",
    title: "Design & Planning",
    body: "Drawings, selections, permits, and detailed value engineering.",
  },
  {
    n: "03",
    title: "Construction",
    body: "Senior PM on-site, weekly client updates, and uncompromising QC.",
  },
  {
    n: "04",
    title: "Final Delivery",
    body: "Punch list, deep clean, walkthrough, and post-occupancy warranty.",
  },
];
...
const TESTIMONIALS = [
  {
    name: "Dr. K. Patel, DVM",
    role: "Hospital Owner — Essex County",
    body: "Haven M delivered our 8,400 sq ft hospital on schedule and to a finish level we didn't think was possible. Their understanding of veterinary workflow is unmatched.",
  },
  {
    name: "Sarah & David L.",
    role: "Whole-home renovation, Montclair",
    body: "Senior PM on-site every week, immaculate site, and a finished home that's better than we imagined. The craftsmanship speaks for itself.",
  },
  {
    name: "Dr. M. Reyes, DVM",
    role: "Clinic Renovation — Bergen County",
    body: "They renovated three exam rooms while we stayed open. Containment was flawless and our staff barely knew construction was happening.",
  },
];
    ...
    <>
      ...
      <section className="relative -mt-20 overflow-hidden bg-[var(--navy-deep)] text-white">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, color-mix(in oklab, var(--navy-deep) 75%, transparent) 0%, color-mix(in oklab, var(--navy-deep) 65%, transparent) 40%, var(--navy-deep) 100%)",
            }}
          />
        </div>
        ...
        <div className="container-x relative grid min-h-[92vh] grid-rows-[1fr_auto] items-end pt-32 pb-12">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl leading-[1.02] text-white md:text-7xl lg:text-[5.5rem]">
              ...
              <span className="italic text-[var(--gold)]">veterinary hospitals</span> & luxury
              spaces.
            </h1>
            <p className="mt-7 max-w-2xl text-base text-white/75 md:text-lg">
              Specialized veterinary hospital construction, commercial build-outs, and premium home
              remodeling throughout New Jersey — engineered with healthcare-grade precision.
            </p>
      ...
      <section className="container-x py-24 md:py-32">
        <Reveal className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <p className="max-w-md text-muted-foreground">
            One licensed team — eight specialized service lines built on the same standard of
            craftsmanship.
          </p>
        </Reveal>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-start">
            <Reveal>
              ...
              <h2 className="mt-3 text-4xl md:text-5xl">
                Why veterinary facilities require specialized construction.
              </h2>
              <p className="mt-5 text-muted-foreground">
                A veterinary hospital isn't a typical commercial build. Patient flow, surgical
                sterility, HVAC zoning, and acoustic separation each demand healthcare-grade
                detailing. We've built our practice around the small decisions that make a facility
                succeed for decades.
              </p>
            ...
            >
              <div className="group relative h-80 overflow-hidden rounded-2xl md:h-96">
                ...
                <div className="absolute inset-x-0 bottom-0 p-7 text-white">
                  <span className="inline-flex rounded-full bg-[var(--gold)]/95 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[var(--navy-deep)]">
                    {p.tag}
                  </span>
      ...
      <section className="relative overflow-hidden bg-[var(--navy-deep)] text-white">
        <div
          ...
          style={{
            background:
              "radial-gradient(60% 60% at 100% 0%, color-mix(in oklab, var(--gold) 25%, transparent), transparent 70%)",
          }}
        />
      ...
      <section className="container-x py-24 md:py-32">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl">
            Trusted by veterinarians and homeowners alike.
          </h2>
        </Reveal>
        ...
        <div className="container-x py-24">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-center">
            <Reveal>
              ...
              <p className="mt-5 text-muted-foreground">
                Headquartered in Verona, we serve veterinary clients and homeowners throughout
