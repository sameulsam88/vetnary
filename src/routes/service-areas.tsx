  ...
  head: () => ({
    meta: [
      { title: "Service Areas — Haven M Construction | Northern New Jersey" },
      {
        name: "description",
        content:
          "Haven M Construction serves Verona, Montclair, Livingston, West Orange, Cedar Grove, and Essex, Bergen, and Passaic counties.",
      },
      { property: "og:title", content: "Haven M Construction Service Areas" },
      {
        property: "og:description",
        content: "Veterinary and luxury construction across Northern New Jersey.",
      },
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <Reveal delay={0.1}>
            ...
            <p className="mt-8 text-sm text-muted-foreground">
              Don't see your town? Veterinary and large remodel projects are considered statewide —
              call us at (201) 264-3506.
            </p>
          </Reveal>
        </div>
      </section>
