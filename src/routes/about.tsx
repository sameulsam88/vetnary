  ...
  head: () => ({
    meta: [
      { title: "About — Haven M Construction | Veterinary & Luxury Builders NJ" },
      {
        name: "description",
        content:
          "Haven M Construction is a Verona, NJ general contractor specializing in veterinary hospitals and luxury home remodeling.",
      },
      { property: "og:title", content: "About Haven M Construction" },
      {
        property: "og:description",
        content:
          "A Verona, NJ general contractor specializing in veterinary hospitals and luxury home remodeling.",
      },
...
const VALUES = [
  {
    ...
    body: "Deep experience with hospital workflow, MEP, and clinical finishes.",
  },
  {
    icon: HardHat,
    title: "Construction Discipline",
    body: "Senior project managers and rigorous on-site QC on every job.",
  },
  {
    icon: ShieldCheck,
    title: "Licensed & Insured",
    body: "Fully licensed NJ general contractor with comprehensive coverage.",
  },
  {
    icon: Award,
    title: "Craftsmanship Standard",
    body: "Finish-carpentry quality from foundation to final walkthrough.",
  },
];
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal>
            ...
            <h2 className="mt-3 text-4xl md:text-5xl">
              Construction expertise built for environments that matter.
            </h2>
            <p className="mt-5 text-muted-foreground">
              Haven M Construction was founded on a simple idea: the same precision required to
              build a surgical suite should inform how we build every kitchen, bathroom, and
              addition. Our team brings veterinary hospital construction experience to every
              project, large or small.
            </p>
            <p className="mt-4 text-muted-foreground">
              From ground-up animal hospitals to whole-home remodels, our work is led by senior
              project managers, executed by trusted trades, and delivered with weekly client
              reporting.
            </p>
          </Reveal>
        </div>
      ...
      <section className="container-x py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <Reveal>
            ...
            <p className="mt-5 text-muted-foreground">
              Every Haven M project is staffed with a senior PM and a dedicated on-site foreman.
              You'll have a single point of contact, weekly progress reports, and complete
              transparency on schedule and budget.
            </p>
            <Link
              to="/contact"
